|Category	|Definition	|Concepts |
|:-----------|:---------:|:---------:|
|Artificial Intelligence (AI)|	Field focused on creating intelligent systems that mimic human thinking and decision-making.	|Artificial Intelligence, Algorithms, Model, Compute|
|Machine Learning (ML)|	Subset of AI where systems learn patterns from data instead of explicit programming.	|Machine Learning, Supervised Learning, Unsupervised Learning, Training Data, Overfitting, Synthetic Data|
...
|Frameworks & AI Ecosystem Tools|	Libraries and platforms used to build GenAI applications and workflows.|	LangChain LangChain, LangGraph LangGraph, Hugging Face Hugging Face, Chains, Tools/Toolkits in LangChain|
