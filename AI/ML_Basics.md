**Artificial Intelligence (AI)** is the ability of computer systems to perform tasks that normally require human intelligence. These tasks include **learning, reasoning, problem-solving, understanding language, recognizing images or speech, and making decisions**.

Examples of AI:

- Voice assistants like **Siri** and **Google Assistant**
-Recommendation systems used by **Netflix** and **YouTube**
-Self-driving technology in vehicles from **Tesla**
-Chatbots such as **ChatGPT**

AI systems imitate aspects of human intelligence by using **algorithms** and **data** to analyze information and improve their performance over time.   

[Subsets of AI] (https://databasetown.com/wp-content/uploads/2023/04/Subsets-of-Artificial-Intelligence-768x1920.jpg)
> AI = Data + Algorithms

**Algorithms** Basic Definition of Algorithm is step by step procedures for solving problems.   
> input > rules/math > output

**Machine Learning** it is a subfield of AI that enables computers to learn from data and make predictions or decisions without being explicitly programmed.  
